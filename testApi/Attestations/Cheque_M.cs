...
// {
//     public string? DateDeDebut_E { get; set; }
//     public string? DateDeDebut_P { get; set; }
//     public string? DateFin_E { get; set; }
//     public string? DateFin_P { get; set; }
//     public string? Agence { get; set; }
...
public class ChequeM : IDocument
{
    ...
    public void Compose(IDocumentContainer container)
    {
        ...
        container.Page(page =>
        {
            page.Header().PaddingLeft(12).PaddingRight(12).Height(60).AlignCenter().Element(Header);
            page.Content().Column(col =>
            {
                ...
                col.Item().PaddingTop(10).Column(col =>
                {
                    ...
                    col.Item().Row(row =>
                    {
                        ...
                        row.RelativeItem().AlignBottom().AlignLeft().PaddingBottom(10).PaddingLeft(15).Column(column =>
                        {
                            column.Item().Text(x =>
                            {
                                x.Span("Date début ECH   :   ").FontFamily("Courie New").FontSize(8).ExtraBold();
                        ...
                        row.RelativeItem().AlignBottom().AlignLeft().PaddingBottom(10).PaddingLeft(15).Column(column =>
                        {
                            column.Item().Text(x =>
                            {
                                x.Span("Date fin ECH   :   ").FontSize(8).FontFamily("Courie New").ExtraBold();
                                x.Span(" 01/01/01  ").FontSize(8).FontFamily("Courie New").ExtraBold();
                            });
                        });
                        // row.RelativeItem().AlignBottom().AlignLeft().PaddingBottom(10).PaddingLeft(15).Text("VF").FontSize(8).ExtraBold();
                        row.RelativeItem().AlignBottom().AlignLeft().PaddingBottom(10).PaddingLeft(15).Column(column =>
                        {
                            column.Item().Text(x =>
                            {
                                x.Span("VF  Date début Prod   :   ").FontSize(8).FontFamily("Courie New").ExtraBold();
                                x.Span(" 01/01/01  ").FontSize(8).FontFamily("Courie New").ExtraBold();
                            });
                        });
                        ...
                        row.RelativeItem().AlignBottom().AlignLeft().PaddingBottom(10).PaddingLeft(15).Column(column =>
                        {
                            column.Item().Text(x =>
                            {
                                x.Span("Date fin Prod   :   ").FontSize(8).FontFamily("Courie New").ExtraBold();
                                x.Span(" 01/01/01  ").FontSize(8).FontFamily("Courie New").ExtraBold();
                            });
                        });
                    });
                ...
                col.Item().PaddingLeft(15).PaddingRight(12).Border(1).BorderColor(Colors.Black).Table(table =>
                {
                    ...
                    table.Cell().Border(1).Padding(2).Text("Montant\nChèque").FontSize(6).ExtraBold().AlignCenter();
                    table.Cell().Border(1).Padding(2).Text("Date\nEchéance").FontSize(6).ExtraBold().AlignCenter();
                    ...
                    table.Cell().Border(1).Padding(3).Text(" 919042").FontSize(6).AlignCenter().ExtraBold();
                    ...
                    table.Cell().Border(1).Padding(3).Text("1 111,00").FontSize(6).AlignCenter().ExtraBold();
                    table.Cell().Border(1).Padding(3).Text("07/04/2025").FontSize(6).AlignCenter().ExtraBold();
                    table.Cell().Border(1).Padding(3).Text("").FontSize(6).AlignCenter();

                    // last cell
                    table.Cell().ColumnSpan(5).Border(1).Padding(3).AlignCenter().Text(text =>
                    {
                    ...
                    table.Cell().ColumnSpan(2).BorderBottom(0).BorderLeft(1).BorderRight(0).BorderTop(0).Padding(3).Text("").FontSize(6).AlignCenter();
                });
    ...
    public void Header(IContainer cont)
    {
        cont.Column(col =>
        {
            ...
            col.Item().Row(row =>
            {
                row.RelativeItem(1).PaddingTop(3).Border(1).BorderColor(Colors.Black).Padding(2).PaddingLeft(1).MaxHeight(40).Image("/Users/amine/OneDrive/Desktop/testApi/depends/images/sntl.webp").FitArea();
                row.RelativeItem(2).PaddingTop(3).Border(1).BorderColor(Colors.Black).PaddingVertical(5).PaddingHorizontal(2).Text("ATTESTATIONS DELIVREES PAR CHEQUES M\n ANNEE 2025").FontSize(12).FontFamily("Times New Roman").ExtraBold().AlignCenter();
                row.RelativeItem(1).PaddingTop(3).Border(1).BorderColor(Colors.Black).Padding(2).Column(col =>
                {
                    ...
                    col.Item().BorderColor(Colors.Black).Padding(2).AlignLeft().Text(txt =>
                    {
