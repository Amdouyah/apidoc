...
public class CreditPPR : IDocument
{
    ...
    public void Compose(IDocumentContainer container)
    {
        ...
        container.Page(page =>
        {
            ...
            page.Content().Column(col =>
            {
                ...
                col.Item().PaddingLeft(15).PaddingTop(10).Column(col =>
                {
                    col.Item().Row(row =>
                    {
                        ...
                        row.RelativeItem(1).AlignBottom().AlignLeft().PaddingLeft(15).Column(column =>
                        {
                            column.Item().Text(x =>
                            {
                                x.Span("Période Date Vente du  :  ").FontSize(8).FontFamily("Courie New").ExtraBold();
                ...
                //agence and caisse
                col.Item().PaddingVertical(2).AlignCenter().Width(400).Column(col =>
                {
                    col.Item().Row(row =>
                {
                    row.Spacing(5);
